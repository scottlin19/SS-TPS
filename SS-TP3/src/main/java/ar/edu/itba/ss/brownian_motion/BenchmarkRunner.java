...
public class BenchmarkRunner {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        CompletableFuture.allOf(
                ...
                CompletableFuture.supplyAsync(()->DCM(50,20,L,maxIter,130,minVelocity,maxVelocity,smallRadius,bigRadius,bigMass,smallMass)).thenAccept(data->createFiles(data,false))
                ).get();
