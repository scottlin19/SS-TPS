...
import ar.edu.itba.ss.brownian_motion.ParticleCollisionEvent;
...
public class Grid {
    ...
    private Set<ParticleCollisionEvent> particleEvents;
    private Set<WallCollisionEvent> wallEvents;
    ...
    public Grid(int L, int M,double RC,boolean hasWalls,List<Particle> particles){
        ...
        this.particleEvents = new HashSet<>();
        this.wallEvents = new HashSet<>();
